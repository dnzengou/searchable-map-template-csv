# ATL nature leaflet map
Searchable Leaflet map with two tile layers, point markers from a timber locations data CSV file built and user high resolution GPS location enabled.

![Screenshot](assets/img/atl-leaflet-map.jpeg)
